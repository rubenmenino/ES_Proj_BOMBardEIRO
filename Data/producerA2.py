...
onlyfiles = [f for f in listdir('./dataset/') if isfile(join('./dataset/', f)) and f.split('_')[0].split('.')[0] == 'a2']

firefighter = {'a2': {'gps': [], 'env':[], 'hr': []}}
...
gps = firefighter['a2']['gps'] + firefighter['a2']['env'] + firefighter['a2']['hr']
