...
onlyfiles = [f for f in listdir('./dataset/') if isfile(join('./dataset/', f)) and f.split('_')[0].split('.')[0] == 'vr12']

firefighter = {'vr12': {'gps': [], 'env':[], 'hr': []}}
...
gps = firefighter['vr12']['gps'] + firefighter['vr12']['env'] + firefighter['vr12']['hr']
